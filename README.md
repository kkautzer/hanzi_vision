...
> Last updated on 11/7/25

> Authors/Contributors: Keagan Kautzer<br>
> _Note: This repo will be sparsely updated throughout the academic year, as I focus on coursework_

## Overview
This repository is home to my Hanzi OCR Project. It contains three individual subdirectories (`character_classifier`, `frontend`, and `server`) each outlined briefly below.
...
4. Scale training to 1000, 1500, and 2000 characters, rather than the current 500
