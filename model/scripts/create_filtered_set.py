...
def create_filtered_set(whitelist_file):
    ...
    source_dir = 'model/data/processed'
    target_dir = f"model/data/filtered/top-{len(whitelist)}"
    ...
    if os.path.isdir(target_dir):
        ...
        if os.path.isfile(f"model/classes/top-{len(whitelist)}-classes.txt"):
...
if __name__=="__main__":
    create_filtered_set(whitelist_file="model/data/whitelist.txt")