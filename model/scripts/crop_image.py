import cv2
import numpy as np
from model.scripts.convert_to_binary_image import convert_image
...
if __name__=="__main__":
    ...
    images = [ # assuming file run from monorepo (using VS code, usually the case for name=main)
        ...
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/我/0001.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/我/0002.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/我/0003.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/我/0004.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/我/0005.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/回/0006.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/回/0007.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/回/0008.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/回/0009.png', np.uint8), cv2.IMREAD_UNCHANGED),
        cv2.imdecode(np.fromfile('./model/data/filtered/top-500/train/回/0010.png', np.uint8), cv2.IMREAD_UNCHANGED),
    ]
